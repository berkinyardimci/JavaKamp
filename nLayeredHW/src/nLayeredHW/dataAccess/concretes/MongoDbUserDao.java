...
public class MongoDbUserDao implements UserDao {
	...
	public void create(User user) {
		users.add(user);
		System.out.println(user.getName() + " Ýsimli kullancý mongoDb veri tabanýna eklendi");
	...
	public void update(User user) {
		...
		System.out.println("Kullanýcý MongoDb databes'inde güncellenmiþtir.--> " + user.getName());
